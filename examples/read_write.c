...
// void append_filename(char* filename) {
//     filename[2] = 'a';
// }


// int look_file_content(char* input_filename) {  
//     input_filename[2] = 'b';
//     //@ slice_preserve_expr input_filename;  
//     //@ slice_preserve_stmt; 
...
int main() {
    ...
    input_filename[2] = 'c';
    input_filename[3] = '\0';
    // append_filename(input_filename);
    // look_file_content(input_filename);
    // // func = add;
...
//     buffer[0] = 1;
//     fwrite(buffer, sizeof(char)*1024, 1, stdout);
//     int a = 1;
//     int b = 2;
//     int c = a + b;
